  ...
  <article class="wrapper">
    ...
    <aside class="[ full-bleed ] [ promo ]">
      <div class="wrapper">
        ...
        <p>
          This element contains the full bleed utility, so it's broken out of
          the article’s horizontal bounds.
        </p>
      </div>
    </aside>
    <p>
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sed odio
      dui. Donec ullamcorper nulla non metus auctor fringilla. Nulla vitae elit
      libero, a pharetra augue. Curabitur blandit tempus porttitor.
    </p>
    <h2 class="fluid-type">
    ...
    <p>
      ...
      interdum. Curabitur blandit tempus porttitor. Cras justo odio, dapibus ac
      facilisis in, egestas eget quam. Etiam porta sem malesuada magna mollis
      euismod. Cras mattis consectetur purus sit amet fermentum. Duis mollis,
    ...
    <figure class="[ full-bleed ] [ feature-figure ]">
      ...
      />
      <figcaption>
        A full bleed image, using the same utility - Photo by Jonathan Borba on
        Unsplash
      </figcaption>
    </figure>
    <p>
      Etiam porta sem malesuada magna mollis euismod. Maecenas sed diam eget
    ...
    <p>
      ...
      Maecenas faucibus mollis interdum. Donec id elit non mi porta gravida at
