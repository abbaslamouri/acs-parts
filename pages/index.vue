  ...
  <main class="flow">
    <header class="section spot-color-primary">
      <div class="section__inner">
        <div class="wrapper flow region">
          ...
          <p>
            Give the browser some solid rules and hints, then let it make the right decisions for the people that visit
            it, based on their device, connection quality and capabilities. This is how they will get a genuinely great
            user experience, rather than a fragmented, broken one.
          </p>
        </div>
      </div>
      <svg
      ...
      <div class="wrapper">
        ...
        <ul class="grid mt-l-xl" role="list" data-rows="masonry" data-layout="50-50">
          <li class="card flow">
            ...
            <p>
              Instead of brute-forcing your designs together with a CSS framework, consider opting for a CSS methodology
              like <a href="https://cube.fyi/">CUBE CSS</a>, <a href="http://smacss.com/">SMACSS</a> or
          ...
          <li class="card flow">
            ...
            <p>
              Creating type scales that respond to the viewport, rather than setting explicit values for typography and
              space allows you to set rules once and forget about them, knowing that whatever device, regardless of its
              available size will be presented with appropriate sizes.
            </p>
          </li>
          <li class="card flow">
            ...
            <p>
              ...
              <a href="https://every-layout.dev/">Every Layout</a>, ensures that regardless of conditions—be it content
              or available screen size: your front-end will be able to respond in the most appropriate way. Giving
              browsers hints and space to do what they do best, helps your front-end handle tricky scenarios where
      ...
      <div class="section flow-space-2xl-3xl spot-color-secondary">
        ...
        <div class="section__inner region">
          <blockquote class="wrapper">
            <p>
              Stick to those principles and making excellent websites that work for everyone suddenly becomes much, much
              easier.
            </p>
          </blockquote>
        </div>
    ...
    <article class="region">
      <div class="wrapper flow prose">
        ...
        <p>
          The article has aged really well, but the practice of web design has not. Oftentimes, designers and developers
          get stuck into pixel-pushing a design into shape with rigid methods to ensure it looks exactly like that
          Figma, Sketch or even Photoshop design. This attitude has stuck around for a long time though, even as far
        ...
        <p>
          ...
          >
          tells us just how fragmented devices are. This was also conducted <strong>7 years ago</strong> and at the time
          of writing, it’s <strong>2022</strong>. That’s a long time for even more fragmentation to occur. Now factor in
          all of the other brands and types of device and you can really see how problematic it is, building websites in
          a rigid, specific manner.
        </p>
        <p>
        ...
        <p>
          ...
          providing a solid, base experience for browsers that don’t yet support those features, thanks to the usage of
          semantic HTML. All in, it’s around 2kb of CSS <strong>in total</strong>.
        </p>
      </div>
    </article>
        ...
        <div class="wrapper flow">
          ...
          <ul class="features grid mt-l-xl" role="list">
            ...
            <li class="flow">
              ...
              <p>
                A series of simple, composable layouts that can be ported to any project. There’s also heaps of learning
                material to help you <em>really</em> learn CSS layout.
              </p>
            </li>
            <li class="flow">
              <div aria-hidden="true">
