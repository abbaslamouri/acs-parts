...
<title>Be the browser’s mentor, not its micromanager. - Build Excellent Websites</title>
<link rel="canonical" href="https://buildexcellentwebsit.es/" />
<meta property="og:site_name" content="Build Excellent Websites" />
<meta property="og:title" content="Be the browser’s mentor, not its micromanager. - Build Excellent Websites" />
<meta property="og:type" content="website" />
<meta property="og:url" content="https://buildexcellentwebsit.es/" />
...
<meta property="og:image:alt" content="Page image for Build Excellent Websites" />
<meta name="twitter:image:alt" content="Page image for Build Excellent Websites" />
<meta name="description" content="Key principles using modern CSS, fluid type, fluid space, flexible layout and progressive enhancement will help you to build better front-ends that work for everyone." />
<meta name="twitter:description" content="Key principles using modern CSS, fluid type, fluid space, flexible layout and progressive enhancement will help you to build better front-ends that work for everyone." />
<meta property="og:description" content="Key principles using modern CSS, fluid type, fluid space, flexible layout and progressive enhancement will help you to build better front-ends that work for everyone." />
<link rel="stylesheet" href="/css/global.css?14e6-1879-1662" />
    ...
    <main class="flow">
      <header class="section spot-color-primary">
        <div class="section__inner">
          <div class="wrapper flow region">
            ...
            <p>
              Give the browser some solid rules and hints, then let it make the right decisions for the people that
              visit it, based on their device, connection quality and capabilities. This is how they will get a
              genuinely great user experience, rather than a fragmented, broken one.
            </p>
          </div>
        </div>
        <svg
        ...
        <div class="wrapper">
          ...
          <ul class="grid mt-l-xl" role="list" data-rows="masonry" data-layout="50-50">
            <li class="card flow">
              ...
              <p>
                Instead of brute-forcing your designs together with a CSS framework, consider opting for a CSS
                methodology like <a href="https://cube.fyi/">CUBE CSS</a>, <a href="http://smacss.com/">SMACSS</a> or
                <a href="http://getbem.com/introduction/">BEM</a> that empowers you to write flexible, portable CSS,
                rather than rigid, inflexible and overly-specific CSS.
              </p>
            </li>
            <li class="card flow">
              <h3>Fluid type &amp; Space</h3>
              <p>
                Creating type scales that respond to the viewport, rather than setting explicit values for typography
                and space allows you to set rules once and forget about them, knowing that whatever device, regardless
                of its available size will be presented with appropriate sizes.
              </p>
            </li>
            <li class="card flow">
              <h3>Flexible Layouts</h3>
              <p>
                Using flexible, flexbox-based layouts, like the ones we provide in
                <a href="https://every-layout.dev/">Every Layout</a>, ensures that regardless of conditions—be it
                content or available screen size: your front-end will be able to respond in the most appropriate way.
                Giving browsers hints and space to do what they do best, helps your front-end handle tricky scenarios
                where breakpoint-based layouts consistently fail.
              </p>
            </li>
            <li class="card flow">
              <h3>Progressive Enhancement</h3>
              <p>
                Building up with the lowest possible technological solution and enhancing it where device capability,
                connection speeds and context conditions allow, helps you build for everyone, not just the minority of
                people that have fast connections and powerful devices that work well, all the time.
              </p>
              <p>
                Doing the opposite: building the best experience, then hacking it down for a handful of selected
                edge-cases means you’re almost certainly going to build an experience that’s excludes a lot of people.
              </p>
            </li>
          </ul>
        </div>
        <div class="section flow-space-2xl-3xl spot-color-secondary">
          ...
          <div class="section__inner region">
            <blockquote class="wrapper">
              <p>
                Stick to those principles and making excellent websites that work for everyone suddenly becomes much,
                much easier.
              </p>
            </blockquote>
          </div>
      ...
      <article class="region">
        <div class="wrapper flow prose">
          <h2>Why though?</h2>
          <p>
            It was in 2010 when <a href="https://twitter.com/beep">Ethan Marcotte</a> published the legendary
            <a href="https://alistapart.com/article/responsive-web-design/">Responsive Web Design</a> article. It
            completely changed how we built websites for an ever-growing variety of device types and sizes.
          </p>
          <p>
            The article has aged really well, but the practice of web design has not. Oftentimes, designers and
            developers get stuck into pixel-pushing a design into shape with rigid methods to ensure it looks exactly
            like that Figma, Sketch or even Photoshop design. This attitude has stuck around for a long time though,
            even as far back as the very early days of the web, which
          ...
          <p>
            We absolutely <strong>don’t know</strong> what our audience device sizes are going to be or whether or not
            they have a decent connection speed, fully working browser or even a bright enough screen to present our
            designs how <strong>we want them to be presented</strong>. We are all guilty of micromanaging the browser in
            some aspects, and in turn, are creating an inflexible and fragile user experience.
          </p>
          <p>
            A better way to approach this is to <strong>be the browser’s mentor</strong> by setting some base rules and
            hints, then getting out of its way to let it make decisions based on the challenges it will
            ...
            >
            tells us just how fragmented devices are. This was also conducted <strong>7 years ago</strong> and at the
            time of writing, it’s <strong>2022</strong>. That’s a long time for even more fragmentation to occur. Now
            factor in all of the other brands and types of device and you can really see how problematic it is, building
            websites in a rigid, specific manner.
          </p>
          <p>
            It makes sense to lose a bit of <strong>perceived control</strong> and instead, get even
            <strong>greater control</strong> by being the browser’s mentor and not its micromanger, right?
          </p>
          <p>
            Go ahead and open up this website on multiple devices or just resize the browser window. You’ll see it deals
            with anything that is thrown at it. It also uses progressive enhancement to leverage modern CSS, while
            providing a solid, base experience for browsers that don’t yet support those features, thanks to the usage
            of semantic HTML. All in, it’s around 2kb of CSS <strong>in total</strong>.
          </p>
        </div>
      </article>
      <article class="section spot-color-primary">
        ...
        <div class="section__inner region">
          <div class="wrapper flow">
            ...
            <p>
              Tools are just tools. They don’t really matter—especially to the people trying to use the websites you
              build. The same goes for frameworks too. The most important thing is that you stick to the key principles.
              Even so, here are some useful tools I use together to build flexible front-ends.
            </p>
              ...
              <li class="flow">
                <div aria-hidden="true">
                  ...
                  >
                    ...
                    <defs>
                      <clipPath id="a"><path fill="#fff" d="M0 0h120v138.182H0z" /></clipPath>
                    </defs>
                  </svg>
                </div>
                <h3>
                ...
                <p>A CSS methodology that’s orientated towards simplicity, pragmatism and consistency.</p>
              </li>
              <li class="flow">
                <div aria-hidden="true">
                  <svg viewBox="0 0 254 254" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                      <clipPath id="utopia">
                        <path fill="currentColor" transform="translate(39 59)" d="M0 0h176v141H0z" />
                      </clipPath>
                    </defs>
                  </svg>
                </div>
                ...
                <p>
                  A handy collection of generators and tools that let you build up various fluid type and space scales
                  depending on viewport sizes to help with responsive design.
                </p>
              </li>
              <li class="flow">
                <div aria-hidden="true">
                  <svg viewBox="0 0 154 112" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip666)" fill="currentColor">
                      <path d="M0 0v93.645h13.11l.263-68.66 16.107-.3V12.96l101.624-.3V0H0Z" />
                      <path
                    ...
                    <defs>
                      <clipPath id="clip666"><path fill="currentColor" d="M0 0h153.429v112H0z" /></clipPath>
                    </defs>
                  </svg>
                </div>
                <h3>
                ...
                <p>
                  A series of simple, composable layouts that can be ported to any project. There’s also heaps of
                  learning material to help you <em>really</em> learn CSS layout.
                </p>
              </li>
              <li class="flow">
                <div aria-hidden="true">
                  <svg viewBox="0 0 85 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                    ...
                    <path
                      ...
                      fill="currentColor"
                    />
                    <circle cx="41.709" cy="47.831" r="12.358" fill="var(--spot-color)" />
                  </svg>
                </div>
                <h3>
                  <a href="https://piccalil.li/tutorial/what-are-design-tokens">Design Tokens</a>
                </h3>
                <p>
                  Centralised data—almost like a database of design values—that could be consumed by anything that
                  understands a standard, like JSON to help with design consistency.
                </p>
              </li>
              <li class="flow">
                <div aria-hidden="true">
                ...
                <h3>
                  <a href="https://a.paddle.com/v2/click/39438/105166?link=3110 ">Polypane</a>
                </h3>
                <p>
                  A handy app that lets you spin up multiple viewports in various configurations to help you build truly
                  responsive sites.
                </p>
              </li>
              <li class="flow">
                ...
                <p>
                  A utility-first CSS framework that is very useful for generating utility classes on demand for CUBE
                  CSS.
                </p>
              </li>
            </ul>
    ...
    <footer class="site-foot" role="contentinfo">
      <div class="wrapper">
        <div class="site-foot__inner">
          <svg aria-hidden="true" focusable="false" viewBox="0 0 101 95" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              opacity=".16"
            ...
            <path
              ...
              fill="#00FFCF"
            />
            <path opacity=".11" d="M65.743 4.767 42.607 17.89l7.763 4.47 15.324-8.657.049-8.936Z" fill="#00FFCF" />
            <path opacity=".07" d="m84.785 44.898-15.49 8.704v9.14l23.326-13.476-7.836-4.368Z" fill="#00D9EE" />
            <path opacity=".05" d="m92.52 48.782-7.735-3.885 7.736-4.52v8.404Z" fill="#00D9EE" />
            <path opacity=".07" d="M92.523 58.065 69.443 71.46l-.211 8.958 31.126-17.984-7.835-4.369Z" fill="#00D9EE" />
            <path opacity=".1" d="m15.896 44.658-7.762 4.47-.063-8.683 7.825 4.213Z" fill="#FD308F" />
            <path
              opacity=".1"
            ...
            <path
              ...
              fill="#00FFCF"
            />
            <path d="M88.468 8.893 50.011 30.94l.544.943L89.01 9.836l-.543-.943Z" fill="#00FFCF" />
          </svg>
          <p>
            By <a href="https://piccalil.li">Andy Bell</a> for <a href="https://set.studio">Set Studio</a>, published in
            2022
          </p>
        </div>
      </div>
