...
<template>
  ...
  <div class="site-wrap">
    ...
    <main tabindex="-1" id="main-content">
      <div class="wrapper">
        <article class="intro">
          <div class="[ intro__header ] [ radius frame ]">
            <h1
              class="[ intro__heading ] [ weight-normal text-400 md:text-600 ]"
            >
      ...
      <article
        class="[ cta ] [ dot-shadow panel ] [ bg-dark-shade color-light ]"
      >
        <div class="wrapper">
          <div class="[ cta__inner ] [ flow ]">
            ...
            >
              This is an agency that doesn’t actually exist
            </h2>
            <p class="[ cta__summary ] [ measure-short ]">
            ...
            <div class="cta__action">
              <a
                class="button"
                data-variant="ghost"
                href="https://piccalil.li/course/learn-eleventy-from-scratch/"
                >Buy a copy</a
              >
            </div>
          </div>
      ...
      <article
        class="[ featured-work ] [ dot-shadow panel ] [ bg-light-glare ]"
      >
          ...
          <div class="[ featured-work__inner ] [ flow ]">
            ...
            ><a
              ...
              ><img
                ...
                alt="A composition of the main landing screen and other key views"
                loading="lazy"
                class="radius"
            /></a>
          </div>
      ...
      <article
        class="[ studio-feed ] [ dot-shadow panel ] [ bg-tertiary-glare ]"
      >
        <div class="[ wrapper ] [ flow flow-space-300 ]">
          ...
          <div class="[ studio-feed__items ] [ flow-space-700 ]">
            <ul class="studio-feed__list">
              <li>
                <img
                  src="https://11tyfromscratch.imgix.net/notepad.jpg?w=890&amp;amp;q=60&amp;amp;auto=format"
              ...
              <li>
                <img
                  src="https://11tyfromscratch.imgix.net/screens.jpg?w=890&amp;amp;q=60&amp;amp;auto=format"
              ...
              <li>
                <img
                  src="https://11tyfromscratch.imgix.net/sketching.jpg?w=890&amp;amp;q=60&amp;amp;auto=format"
              ...
              <li>
                <img
                  src="https://11tyfromscratch.imgix.net/smiling.jpg?w=890&amp;amp;q=60&amp;amp;auto=format"
              ...
              <li>
                <img
                  src="https://11tyfromscratch.imgix.net/studio.jpg?w=890&amp;amp;q=60&amp;amp;auto=format"
              ...
              <li>
                <img
                  src="https://11tyfromscratch.imgix.net/table-tennis.jpg?w=890&amp;amp;q=60&amp;amp;auto=format"
        ...
        <div class="wrapper">
          <div class="[ cta__inner ] [ flow ]">
            <h2
              ...
              data-highlight="quaternary"
            >
              Get in touch if we seem like a good fit
            </h2>
            <p class="[ cta__summary ] [ measure-short ]">
              Vestibulum id ligula porta felis euismod semper. Praesent commodo
              cursus magna, vel scelerisque nisl consectetur et. Cras justo
              odio, dapibus ac facilisis in, egestas eget quam. Donec
              ullamcorper nulla non metus auctor fringilla.
            </p>
            <div class="cta__action">
              <a class="button" data-variant="ghost" href="/contact/"
    ...
    <footer role="contentinfo" class="site-foot">
      <div class="wrapper">
        <p>
          This is a made up agency for the course,
          <a href="https://piccalil.li/course/learn-eleventy-from-scratch/"
            >“Learn Eleventy From Scratch”</a
          >.
        </p>
      </div>
    </footer>
