    ...
    <div class="grid grid-cols-12 gap-6">
      ...
      <div class="col-span-9">
        <div class="grid grid-cols-3 gap-4">
          <div class="rounded bg-slate-50 p-4 text-sm text-gray-500 shadow">
            <div class="flex justify-between">
              <h3 class="font-bold capitalize">Personal profile</h3>
              <button class="text-primary-light hover: txt-gray-400">Edit</button>
            </div>
            <div class="space-y mt-3">
              <h3 class="">Abbas Lamouri</h3>
              <div>Abbaslamouri@yrlus.com</div>
              <div>216-502-6378</div>
            </div>
          </div>
          <div class="rounded bg-slate-50 p-4 text-sm text-gray-500 shadow">
            <div class="flex justify-between">
              <h3 class="font-bold capitalize">Shipping Address</h3>
              <button class="text-primary-light hover: txt-gray-400">Edit</button>
            </div>
            <div class="space-y mt-3">
              <h3 class="">Abbas Lamouri</h3>
              <div>599 Deep Woods Dr.</div>
              <div>Aurora, OH 44202</div>
              <div>216-502-6378</div>
            </div>
          </div>
          <div class="rounded bg-slate-50 p-4 text-sm text-gray-500 shadow">
            <div class="flex justify-between">
              <h3 class="font-bold capitalize">Billing address</h3>
              <button class="text-primary-light hover: txt-gray-400">Edit</button>
            </div>
            <div class="space-y mt-3">
              <h3 class="">Abbas Lamouri</h3>
