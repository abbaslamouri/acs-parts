...
<template>
  <div class="flex flex-row gap-2 justify-center items-center p-4 bg-slate-300 text-lg uppercase">
    <div
      class="flex-1 flex flex-col gap-1 items-center bg-slate-600 text-slate-50 p-4 rounded"
